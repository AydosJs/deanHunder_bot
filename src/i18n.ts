...
export const copy = {
  en: {
    welcome:'👀 Seen the dean?', find:'🔎 Find dean', report:'📍 Report', base:'🏠 At base',
    ...
    expired:'⌛ That sighting expired.', also:'⚠️ Also reported:', office:'🏠 At base · Dean’s office',
  ...
  ru: {
    welcome:'👀 Видели декана?', find:'🔎 Где декан?', report:'📍 Сообщить', base:'🏠 На базе',
    coffee:'☕ На кофе', help:'❔ Помощь', menu:'⌂ Меню', floors:'‹ Этажи', floor:'Этаж', room:'Кабинет',
    here:'✅ Здесь', nope:'❌ Нет', left:'🚶 Ушёл', refresh:'↻ Обновить',
    chooseFloor:'📍 Какой этаж?', chooseRoom:'Выберите кабинет', empty:'🤷 Свежих сообщений нет. Видели декана?',
    ...
    expired:'⌛ Это сообщение устарело.', also:'⚠️ Также сообщают:', office:'🏠 На базе · Кабинет декана',
  ...
  uz: {
    welcome:'👀 Dekanni ko‘rdingizmi?', find:'🔎 Dekan qayerda?', report:'📍 Xabar berish', base:'🏠 O‘z xonasida',
    ...
    chooseFloor:'📍 Qaysi qavat?', chooseRoom:'Xonani tanlang', empty:'🤷 Yangi xabar yo‘q. Dekanni ko‘rdingizmi?',
    ...
    expired:'⌛ Bu xabar eskirgan.', also:'⚠️ Yana bir xabar:', office:'🏠 O‘z xonasida · Dekan xonasi',
